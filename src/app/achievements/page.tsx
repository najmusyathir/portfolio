...
export const metadata: Metadata = {
  title: "Achievements",
  description:
    "Awards and invited roles — Best Industrial Panel Final Year Project (2024), and returning to the same panel as an invited jury member in 2026.",
};
          ...
          <div className="container">
            <Reveal>
              <SectionHeading
                ...
                intro="Two entries, and the line between them is the point: the award an industrial panel gave me as a student in 2024 is the one I was invited back to help judge in 2026."
              />
            </Reveal>
          </div>
        </section>
